...
const Certifications = () => {
  ...
  const certificationCourses = data.certifications.edges.filter(({ node }) => node);
    ...
    <section id="certifications">
      ...
      <div>
        {certificationCourses &&
          certificationCourses.map(({ node }, i) => {
            ...
            return (
              <StyledProject key={i} ref={el => (revealProjects.current[i] = el)}>
                <div className="project-content">
                  <p className="project-overline">Certification Courses</p>
